...
class GUI(Frame):
    def __init__(self, parent=None):
        ...
        self.resultLabel = Label(self, text="COPY MOVE DETECTOR", font = ("Times Roman", 40))
        self.resultLabel.grid(row=0, column=0, columnspan=2)
        Grid.rowconfigure(self, 0, weight=1)

        # Get the blank image
        blank_img = getImage("D:\Downloads\CF_detector\CF_detector\main\images\\blank.png", IMG_WIDTH, IMG_HEIGHT)
        ...
        self.fileLabel = Label(self, text="No file selected", fg="red", font = ("Times", 15))
        ...
        s = ttk.Style()
        s.configure('my.TButton', foreground='Blue', font=('Times', 15))
    ...
    def runProg(self):
        ...
        if result:
            ...
            img = getImage("D:\Downloads\CF_detector\CF_detector\main\images\\thumbs_up.png", IMG_WIDTH, IMG_HEIGHT)
            self.resultPanel.configure(image=img)
            self.resultPanel.image = img
